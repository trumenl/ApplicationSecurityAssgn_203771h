<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="403.aspx.cs" Inherits="ApplicationSecurityAssgn_203771h._403" %>
...
<body>
    ...
    <div class="text">
      ...
      <h2>Forbidden page :(</h2>
         <h3>You have no access to this page - lets take you <a href="login.aspx">BACK</a></h3> 
    </div>
